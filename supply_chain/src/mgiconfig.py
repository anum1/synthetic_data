...
Adapted from the sibling ApexTech sales dataset; the timeline semantics are
identical so both datasets anchor to the same as-of convention.
"""
...
class Scenario:
    ...
    def inventory(self) -> dict:
        return self.cfg["inventory"]

    @property
    def classification(self) -> dict:
        return self.cfg["classification"]

    @property
    def risk(self) -> dict:
        return self.cfg["risk"]

    @property
    def financial(self) -> dict:
        return self.cfg["financial"]

    @property
    def forecast(self) -> dict:
        return self.cfg["forecast"]
