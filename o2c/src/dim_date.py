"""Calendar dimension: Gregorian + fiscal + the flags O2C actually needs.

Leaner than the HR sibling's version - there are no per-country payroll
calendars here. What this one carries instead is a business-day flag and a
business-day ordinal, because payment terms, invoice ageing and promised-date
performance are all counted in business days, and doing that with a window
function in five different BI tools produces five different answers.
"""
