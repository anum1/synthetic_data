"""Calendar dimension: Gregorian + fiscal + the flags P2P actually needs.

Ported unchanged from the Vantage O2C sibling. What earns its keep here is
`business_day_index`: payment terms, invoice ageing, the discount window and
approval SLAs are all counted in business days, and doing that with a window
